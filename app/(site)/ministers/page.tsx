...
const PLACEHOLDER_TEAM = [
  {
    ...
    title: 'Local Pastor',
    role: 'Lead Shepherd',
    shortBio: 'Serving with a passion for biblical truth and community transformation. Pastor Akoko has been leading DCLM Lewisville for over 15 years.',
    photo: null,
  ...
  },
  {
    _id: '2',
    name: 'Sarah Johnson',
    title: 'Women\'s Leader',
    role: 'Ministry Director',
    shortBio: 'Dedicated to empowering women to grow in faith and find their purpose in God’s kingdom through mentorship and prayer.',
    photo: null,
  ...
  },
  {
    ...
    photo: null,
    email: 'youth@dclmlewisville.org'
  }
]
            ...
            {teamMembers.map((member: any) => (
              ...
              >
                ...
                <div className="aspect-[4/5] relative bg-slate-200 overflow-hidden">
                  {member.photo ? (
                    <Image
                      src={urlFor(member.photo).width(800).height(1000).url()}
                      alt={member.name}
                      fill
