  ...
  return (
    <section className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-white/10  blur-3xl" />
      </div>
      ...
      {/* Decorative elements */}
      <div className="absolute top-10 left-10 w-20 h-20 border-4 border-white/10  animate-pulse" />
      <div className="absolute bottom-10 right-10 w-32 h-32 border-4 border-white/10  animate-pulse" style={{ animationDelay: '1s' }} />
    </section>
  )
}