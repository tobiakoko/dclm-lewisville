  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-10 left-10 w-96 h-96 bg-accent/20  blur-3xl" />
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-primary/20  blur-3xl" />
      </div>
      ...
      <div className="container relative z-10">
          ...
          {ministries.map((ministry, index) => {
            ...
            return (
              <Link
                ...
                className="group relative bg-gradient-to-br from-white to-muted/30  p-8 hover:shadow-2xl transition-all duration-500 border-2 border-border hover:border-primary/50 animate-fade-in-up hover:-translate-y-2"
              ...
              >
                ...
                <div className="relative z-10">
                  {/* Icon */}
                  <div className="w-20 h-20 bg-gradient-to-br from-primary via-secondary to-accent  flex items-center justify-center mb-6 shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-500 group-hover:rotate-6">
        ...
        <div className="text-center animate-fade-in-up animate-delay-500">
          <Button
            asChild
            size="lg"
            className="bg-gradient-to-r from-primary to-primary hover:shadow-lg transition-all duration-300 hover:scale-105 group text-lg px-8 py-6 h-auto"
          >
